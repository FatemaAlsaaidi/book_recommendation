...
book_names = pickle.load(open('pkl/books_name.pkl', 'rb'))
final_rating = pickle.load(open('pkl/final_rating.pkl', 'rb'))
book_pivot = pickle.load(open('pkl/book_pivot.pkl', 'rb'))
